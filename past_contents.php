   <?php  
              ...
              $connect = $common->connect(); 
               ...
               $all_posts_array = $common->get_past_posts_from_campaign_id($campaignid,$event_id);
                  ...
                  if(count($all_posts_array)){
                        echo '<div class="row">
                                            <div class="col-sm-12 col-md-12 pt-3">
                                              <a class="btn btn-success pull-right export" href="sp-past-post-export.php?event_id='.$event_id.'&campid='.$campaignid.'">Export</a>
                                              <button type="button" class="btn btn-success pull-right get-code" onclick="copyTxtApproved3()" id="copy_url_master3"><span class="bg">Get Embeded Code</span><span class="cpTextApprovedTxt" style="display: none;">Link Copied!</span></button>
                                                  <div class="col-lg-12 form-group" style="position: absolute;opacity: 0;z-index: -1;">
                                                   <div style="float: left; width: 100%;">
                                                    <input  type="hidden" class="form-control required"  id="approved_spk_url3" />
                                                      <input style="width: 86%;float: left;" type="text" class="form-control required" id="approved_spk_url_show3" readonly="true" value="'.htmlspecialchars($cpy_url_public).'"  />
                                                   </div>
                                                </div>
                                              ...
                                              <div class="content-tab-box">
                                                ...
                                                <div class="row">
                                                  <div class="col-md-3">
                                                    ...
                                                    if($all_posts['fb_platform']=='1')
                                                    {
                                                      echo '<input type="checkbox"  value="1" name="fbcheck" id="check_'.$all_posts['id'].'" checked>';
                                                    }else
                                                    {
                                                       echo '<input type="checkbox" value="1" name="fbcheck" id="check_'.$all_posts['id'].'">';
                                                    }
                                                  ...
                                                  <div class="col-md-3">
                                                    ...
                                                    {
                                                      echo '<input type="checkbox"  value="1" name="instacheck" id="check1_'.$all_posts['id'].'" checked>';
                                                    }else
                                                    {
                                                       echo '<input type="checkbox" value="1" name="instacheck" id="check1_'.$all_posts['id'].'">';
                                                    }
                                                  ...
                                                  <div class="col-md-3">
                                                    <div class="platform-check">';
                                                      ...
                                                      {
                                                        echo '<input type="checkbox"  value="1" name="lincheck" id="check2_'.$all_posts['id'].'" checked>';
                                                      }else
                                                      {
                                                         echo '<input type="checkbox" value="1" name="lincheck" id="check2_'.$all_posts['id'].'">';
                                                      }
                                                  ...
                                                  <div class="col-md-3">
                                                    ...
                                                    if($all_posts['is_twitter']=='1')
                                                      {
                                                        echo '<input type="checkbox"  value="1" name="twicheck" id="check3_'.$all_posts['id'].'" checked>';
                                                      }else
                                                      {
                                                          echo '<input type="checkbox" value="1" name="twicheck" id="check3_'.$all_posts['id'].'">';
                                                      }
