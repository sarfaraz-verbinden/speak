   <?php  
              ...
              $connect = $common->connect(); 
               ...
               $all_posts_array = $common->get_posts_from_campaign_id($campaignid,$event_id);
                   ...
                   if(count($all_posts_array)){
                        echo '<div class="row">
                                            <div class="col-sm-12 col-md-12 pt-3">
                                              <a class="btn btn-success pull-right export" href="sp-live-post-export.php?event_id='.$event_id.'&campid='.$campaignid.'">Export</a>
                                               <button type="button" class="btn btn-success pull-right get-code" onclick="copyTxtApproved()" id="copy_url_master"><span class="bg">Get Embeded Code</span><span class="cpTextApprovedTxt" style="display: none;">Link Copied!</span></button>
                                                  <div class="col-lg-12 form-group" style="position: absolute;opacity: 0;z-index: -1;">
                                                   <div style="float: left; width: 100%;">
                                                    <input  type="hidden" class="form-control required"  id="approved_spk_url" />
                                                      <input style="width: 86%;float: left;" type="text" class="form-control required" id="approved_spk_url_show" readonly="true" value="'.htmlspecialchars($cpy_url_public).'"  />
                                                   </div>
                                                </div>
                ...
                foreach($all_posts_array as $all_posts){
                 ...
                 $all_status_array = $common->fetch_all_social_media_status($event_id); 
                  ...
                  $status_dropdown = $status_dropdown. "</select>";
                                            ...
                                            <div class="col-sm-12 col-md-4">
                                              <div class="content-tab-box">
                                                ...
                                                '.date("d-M-Y",strtotime($all_posts['target_date'])).'
                                                  ...
                                                  <div class="details">
                                                    <p class="pt-3">
                                                      <label style="top: 16px;">Post Name</label>
                            ...
                            if(!count($all_posts_array)){
                              echo '<div calss="no_data"><center>No Data Found</center></div>';
                           }
